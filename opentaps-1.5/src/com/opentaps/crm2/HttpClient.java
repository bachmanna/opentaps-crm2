    ...
    private InputStream sendHttpRequestStream(String method, boolean overrideTrust) throws HttpClientException {
        ...
        try {
            ...
            if ((con instanceof HttpURLConnection)) {
                ...
                ((HttpURLConnection) con).setReadTimeout(timeout);
                ((HttpURLConnection) con).setConnectTimeout(connectTimeout);
            ...
            if ((trustAny && !overrideTrust) && (ioe.getCause() instanceof CertificateException || ioe.getCause() instanceof SSLHandshakeException)) {
